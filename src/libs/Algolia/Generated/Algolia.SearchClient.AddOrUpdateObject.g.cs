...
namespace Algolia
{
    public partial class SearchClient
    {
        ...
        private static readonly global::Algolia.EndPointSecurityRequirement s_AddOrUpdateObjectSecurityRequirement0 =
        ...
        private static readonly global::Algolia.EndPointSecurityRequirement[] s_AddOrUpdateObjectSecurityRequirements =
            new global::Algolia.EndPointSecurityRequirement[]
            {                s_AddOrUpdateObjectSecurityRequirement0,
            };
        partial void PrepareAddOrUpdateObjectArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string indexName,
            ref string objectID,
            object request);
        partial void PrepareAddOrUpdateObjectRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string indexName,
            string objectID,
            object request);
        partial void ProcessAddOrUpdateObjectResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAddOrUpdateObjectResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Algolia.AddOrUpdateObjectResponse> AddOrUpdateObjectAsync(
            string indexName,
            string objectID,
        ...
        {
            var __response = await AddOrUpdateObjectAsResponseAsync(
                indexName: indexName,
                objectID: objectID,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Algolia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Algolia.AutoSDKHttpResponse<global::Algolia.AddOrUpdateObjectResponse>> AddOrUpdateObjectAsResponseAsync(
            string indexName,
            string objectID,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAddOrUpdateObjectArguments(
            ...
            var __authorizations = global::Algolia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AddOrUpdateObjectSecurityRequirements,
                operationName: "AddOrUpdateObjectAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Algolia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Algolia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AddOrUpdateObjectAsync",
                                pathTemplate: "$\"/1/indexes/{indexName}/{objectID}\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAddOrUpdateObjectResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Algolia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAddOrUpdateObjectResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Algolia.AddOrUpdateObjectResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Algolia.AutoSDKHttpResponse<global::Algolia.AddOrUpdateObjectResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Algolia.AddOrUpdateObjectResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await AddOrUpdateObjectAsync(
                indexName: indexName,
                objectID: objectID,
                request: __request,
                requestOptions: requestOptions,
