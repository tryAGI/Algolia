...
namespace Algolia
{
    public partial class SearchClient
    {
        ...
        {
            var __response = await PartialUpdateObjectAsResponseAsync(
                indexName: indexName,
                objectID: objectID,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Algolia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Algolia.AutoSDKHttpResponse<global::Algolia.PartialUpdateObjectResponse>> PartialUpdateObjectAsResponseAsync(
            string indexName,
            string objectID,
                    ...
                    await global::Algolia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Algolia.PartialUpdateObjectResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Algolia.AutoSDKHttpResponse<global::Algolia.PartialUpdateObjectResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Algolia.PartialUpdateObjectResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
