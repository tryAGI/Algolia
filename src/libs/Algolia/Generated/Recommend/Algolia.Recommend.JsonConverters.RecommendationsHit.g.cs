...
{
    /// <inheritdoc />
    public class RecommendationsHitJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Algolia.Recommend.RecommendationsHit>
    {
        /// <inheritdoc />
        public override global::Algolia.Recommend.RecommendationsHit Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            if (__jsonProps.Contains("_score")) __score1++;
            ...
            global::Algolia.Recommend.RecommendHit? recommend = default;
            global::Algolia.Recommend.TrendingFacetHit? trendingFacetHit = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        trendingFacetHit = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (recommend == null && trendingFacetHit == null)
            {
                try
                {
                    var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Algolia.Recommend.RecommendHit), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Algolia.Recommend.RecommendHit> ??
            ...
            var __value = new global::Algolia.Recommend.RecommendationsHit(
                recommend,
        ...
        public override void Write(
            ...
            global::Algolia.Recommend.RecommendationsHit value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
