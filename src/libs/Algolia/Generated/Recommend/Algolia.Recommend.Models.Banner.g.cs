...
namespace Algolia.Recommend
{
    ...
    public sealed partial class Banner
    {
        ...
        public global::Algolia.Recommend.BannerImage? Image { get; set; }

        /// <summary>
        /// Link for a banner defined in the Merchandising Studio.
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("link")]
        public global::Algolia.Recommend.BannerLink? Link { get; set; }
...
#endif
        public Banner(
            global::Algolia.Recommend.BannerImage? image,
            global::Algolia.Recommend.BannerLink? link)
        {
            this.Image = image;
            this.Link = link;
        }
