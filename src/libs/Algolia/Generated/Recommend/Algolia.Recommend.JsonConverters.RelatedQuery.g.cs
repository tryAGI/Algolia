...
{
    /// <inheritdoc />
    public class RelatedQueryJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Algolia.Recommend.RelatedQuery>
    {
        /// <inheritdoc />
        public override global::Algolia.Recommend.RelatedQuery Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Algolia.Recommend.RelatedProducts? products = default;
            try
            {
                ...
                products = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
            }
            catch (global::System.Text.Json.JsonException)
            {
            }
            ...
            var __value = new global::Algolia.Recommend.RelatedQuery(
        ...
        public override void Write(
            ...
            global::Algolia.Recommend.RelatedQuery value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            if (value.IsProducts)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Algolia.Recommend.RelatedProducts), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Algolia.Recommend.RelatedProducts?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Algolia.Recommend.RelatedProducts).Name}");
                var __element1 = global::System.Text.Json.JsonSerializer.SerializeToElement(value.Products!, typeInfo);
