...
{
    /// <inheritdoc />
    public class TypoToleranceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Algolia.Recommend.TypoTolerance>
    {
        /// <inheritdoc />
        public override global::Algolia.Recommend.TypoTolerance Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Algolia.Recommend.TypoToleranceEnum), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
        ...
        public override void Write(
            ...
            global::Algolia.Recommend.TypoTolerance value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
