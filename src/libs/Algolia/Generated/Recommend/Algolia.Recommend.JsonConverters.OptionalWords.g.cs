...
{
    /// <inheritdoc />
    public class OptionalWordsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Algolia.Recommend.OptionalWords>
    {
        /// <inheritdoc />
        public override global::Algolia.Recommend.OptionalWords Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        optionalWordsVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
            ...
            var __value = new global::Algolia.Recommend.OptionalWords(
        ...
        public override void Write(
            ...
            global::Algolia.Recommend.OptionalWords value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsOptionalWordsVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(string), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<string?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(string).Name}");
