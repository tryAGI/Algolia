...
namespace Algolia.Recommend
{
    public partial class RecommendClient
    {
        ...
        {
            var __response = await SearchRecommendRulesAsResponseAsync(
                indexName: indexName,
                model: model,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Algolia.Recommend.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Algolia.Recommend.AutoSDKHttpResponse<global::Algolia.Recommend.SearchRecommendRulesResponse>> SearchRecommendRulesAsResponseAsync(
            string indexName,
            global::Algolia.Recommend.RecommendModels model,
                    ...
                    await global::Algolia.Recommend.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Algolia.Recommend.SearchRecommendRulesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Algolia.Recommend.AutoSDKHttpResponse<global::Algolia.Recommend.SearchRecommendRulesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Algolia.Recommend.SearchRecommendRulesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
