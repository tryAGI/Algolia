...
{
    /// <inheritdoc />
    public class AutoFilteringFilterEntryJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Algolia.AutoFilteringFilterEntry>
    {
        /// <inheritdoc />
        public override global::Algolia.AutoFilteringFilterEntry Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            string? autoFilteringFilterEntryVariant1 = default;
            global::System.Collections.Generic.IList<string>? autoFilteringFilterEntryVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        autoFilteringFilterEntryVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        autoFilteringFilterEntryVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            var __value = new global::Algolia.AutoFilteringFilterEntry(
        ...
        public override void Write(
            ...
            global::Algolia.AutoFilteringFilterEntry value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsAutoFilteringFilterEntryVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(string), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<string?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(string).Name}");
