...
{
    /// <inheritdoc />
    public class InsideBoundingBoxJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Algolia.InsideBoundingBox>
    {
        /// <inheritdoc />
        public override global::Algolia.InsideBoundingBox Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        insideBoundingBoxVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
            ...
            var __value = new global::Algolia.InsideBoundingBox(
        ...
        public override void Write(
            ...
            global::Algolia.InsideBoundingBox value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsInsideBoundingBoxVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(string), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<string?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(string).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.InsideBoundingBoxVariant1!, typeInfo);
            }
            else if (value.IsInsideBoundingBoxVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(object), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<object?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(object).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.InsideBoundingBoxVariant2!, typeInfo);
            }
