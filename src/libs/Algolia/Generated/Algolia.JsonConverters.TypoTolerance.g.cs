...
{
    /// <inheritdoc />
    public class TypoToleranceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Algolia.TypoTolerance>
    {
        /// <inheritdoc />
        public override global::Algolia.TypoTolerance Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::Algolia.TypoToleranceEnum), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            bool? value1 = default;
            global::Algolia.TypoToleranceEnum? value2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::Algolia.TypoTolerance(
                value1,
        ...
        public override void Write(
            ...
            global::Algolia.TypoTolerance value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
