...
namespace Algolia
{
    public partial class SearchClient
    {
        ...
        private static readonly global::Algolia.EndPointSecurityRequirement s_SearchSingleIndexSecurityRequirement0 =
        ...
        private static readonly global::Algolia.EndPointSecurityRequirement[] s_SearchSingleIndexSecurityRequirements =
            new global::Algolia.EndPointSecurityRequirement[]
            {                s_SearchSingleIndexSecurityRequirement0,
            };
        partial void PrepareSearchSingleIndexArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string indexName,
            global::Algolia.SearchParams request);
        partial void PrepareSearchSingleIndexRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string indexName,
            global::Algolia.SearchParams request);
        partial void ProcessSearchSingleIndexResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSearchSingleIndexResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Algolia.SearchResponse> SearchSingleIndexAsync(
            string indexName,
        ...
        {
            var __response = await SearchSingleIndexAsResponseAsync(
                indexName: indexName,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Algolia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Algolia.AutoSDKHttpResponse<global::Algolia.SearchResponse>> SearchSingleIndexAsResponseAsync(
            string indexName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSearchSingleIndexArguments(
            ...
            var __authorizations = global::Algolia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SearchSingleIndexSecurityRequirements,
                operationName: "SearchSingleIndexAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSearchSingleIndexRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Algolia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Algolia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SearchSingleIndexAsync",
                                pathTemplate: "$\"/1/indexes/{indexName}/query\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSearchSingleIndexResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Algolia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSearchSingleIndexResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Algolia.SearchResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Algolia.AutoSDKHttpResponse<global::Algolia.SearchResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Algolia.SearchResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await SearchSingleIndexAsync(
                indexName: indexName,
                request: __request,
                requestOptions: requestOptions,
