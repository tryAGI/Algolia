...
namespace Algolia.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "Algolia.CLI";
    private const string UserSecretApiKeyName = "ALGOLIA_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"ALGOLIA_API_KEY"];
    private const string CredentialFileDirectoryName = ".algolia";

    public static async global::System.Threading.Tasks.Task<global::Algolia.AlgoliaClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Algolia.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Algolia.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Algolia.AlgoliaClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Algolia.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Algolia.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Algolia.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Algolia.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("ALGOLIA_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Algolia.ApiException exception)
    {
        var builder = new StringBuilder();
