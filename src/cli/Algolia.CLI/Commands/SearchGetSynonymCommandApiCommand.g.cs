...
internal static partial class SearchGetSynonymCommandApiCommand
{
        ...
        name: @"object-id")
    {
        Description = @"Unique identifier of a synonym object.",
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Algolia.SynonymHit value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Algolia.SynonymHit value, ref string? text);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Search.GetSynonymAsync(
                                    indexName: indexName,
                                    objectID: objectID,
