...
internal static partial class SearchGetRuleCommandApiCommand
{
        ...
        name: @"object-id")
    {
        Description = @"Unique identifier of a rule object.",
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Algolia.Rule value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Algolia.Rule value, ref string? text);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Search.GetRuleAsync(
                                    indexName: indexName,
                                    objectID: objectID,
