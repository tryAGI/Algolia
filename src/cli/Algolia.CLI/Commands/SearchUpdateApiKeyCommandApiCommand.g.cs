...
internal static partial class SearchUpdateApiKeyCommandApiCommand
{
    ...
    private static readonly ApiKeyOptionSet ApiKeyOptionSetOptions = ApiKeyOptionSet.Create();
      ...
      private static Option<string?> RequestFile { get; } = new(@"--request-file")
      {
          ...
          Hidden = true,
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Algolia.UpdateApiKeyResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Algolia.UpdateApiKeyResponse value, ref string? text);
...
");
                        command.Arguments.Add(Key);                        command.Options.Add(ApiKeyOptionSetOptions.Acl);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var key = parseResult.GetRequiredValue(Key);                        var acl = parseResult.GetRequiredValue(ApiKeyOptionSetOptions.Acl);
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Search.UpdateApiKeyAsync(
                                    key: key,
                                    acl: acl,
